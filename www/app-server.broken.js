...
// Legacy appData for backward compatibility (maps to current session)
let currentReferenceCode = null;

// Service Initialization (using alternative APIs)
