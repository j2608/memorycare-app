...
// Firebase Config (from firebase-config.json)
const firebaseConfig = {
    apiKey: "AIzaSyD6eGCuIPrCdgLBGGdcQxBqmNiZdl9iLcI",
    authDomain: "memory-care-app-ebad2.firebaseapp.com",
    databaseURL: "https://memory-care-app-ebad2-default-rtdb.firebaseio.com",
    projectId: "memory-care-app-ebad2",
    storageBucket: "memory-care-app-ebad2.appspot.com",
...
function enableAutoSync() {
    ...
    localStorage.setItem = function(key, value) {
        ...
        // Auto-sync to Firebase if memorycare data
        if (key.startsWith('memorycare_')) {
            const cleanKey = key.replace('memorycare_', '');
            if (firebaseInitialized && firebaseDB) {
                firebaseDB.ref(cleanKey).set(JSON.parse(value)).catch(err => {
